...
Ответ возвращается структурой с полями:
- answer — сам текст ответа со ссылками на фрагменты;
- has_answer — есть ли ответ в контексте;
- citations — номера фрагментов, на которые опирается ответ."""
